...
# for the 003-VM-IPERF3 test case.
#
...
echo "======================================================="
echo "🛡️  Unified GDC Service Account Bootstrapper (VM iperf3)"
echo "======================================================="
...
echo ""
echo "  2) Deploy VM iperf3 resources (Restricted Runner SA Context):"
