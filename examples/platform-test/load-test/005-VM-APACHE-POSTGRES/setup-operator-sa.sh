...
# for the 005-VM-APACHE-POSTGRES test case.
#
...
echo "======================================================="
echo "🛡️  Unified GDC Service Account Bootstrapper (VM Web + DB)"
echo "======================================================="
...
echo ""
echo "  2) Deploy VM Web + DB resources (Restricted Runner SA Context):"
