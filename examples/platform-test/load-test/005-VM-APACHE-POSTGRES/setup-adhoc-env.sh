#!/bin/bash
# setup-adhoc-env.sh: Unified interactive flow for 005-VM-APACHE-POSTGRES
...
echo "================================================="
echo "🔐 005-VM-APACHE-POSTGRES: Unified Setup"
echo "================================================="
...
echo ""
echo "🚀 STEP 3: Launching VM Web + DB Workload Provisioning..."
