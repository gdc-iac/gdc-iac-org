...
# for the 002-CONTAINER-IPERF3 test case.
#
...
echo "======================================================="
echo "🛡️  Unified GDC Service Account Bootstrapper (iperf3)"
echo "======================================================="
...
echo "     KUBECONFIG=$KUBECONFIG_SA ${VERSION_PREFIX}GLOBAL_API_CONTEXT=bootstrap-global-context ADMIN_CLUSTER_CONTEXT=bootstrap-admin-context helmfile --selector tier!=iperf3 sync"
echo ""
echo "  2) Deploy Container iperf3 workloads (Restricted Runner SA Context):"
echo "     KUBECONFIG=$KUBECONFIG_SA ${VERSION_PREFIX}GLOBAL_API_CONTEXT=bootstrap-global-context ADMIN_CLUSTER_CONTEXT=runner-admin-context helmfile --selector tier=iperf3 sync"
echo ""
