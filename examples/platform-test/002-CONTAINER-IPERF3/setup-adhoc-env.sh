#!/bin/bash
# setup-adhoc-env.sh: Unified interactive flow for 002-CONTAINER-IPERF3
...
echo "================================================="
echo "🔐 002-CONTAINER-IPERF3: Unified Platform Setup"
echo "================================================="
...
echo ""
echo "🚀 STEP 3: Launching iperf3 Container Workload Provisioning..."
