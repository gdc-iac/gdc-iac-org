...
export CLUSTER_NAME="clstr-20260402"
...
export S3_PROXY_IMAGE="data-ets-shr-mhs-data-ets-infra.org-15357.lux-central1-b.lux.clr/dga/s3-proxy:latest"
export AIS_PREFIX="gdch-infra-operator-"
export S3_PROXY_ENABLED="yes"
export CLUSTER_K8S_VERSION="1.30.14-gke.2300"
...
export CLUSTER_NODE_POOL_NAME="pool-20260402"
