...
export OUTPUT_DIR="/mnt/c/temp/dga-factory"
export SECRETS_DIR="/mnt/c/temp/dga-factory-secrets"
...
export KUBECONFIG_PATH="/mnt/c/temp/dga-factory-secrets"
...
export AIS_PREFIX="org-15357-user-"
