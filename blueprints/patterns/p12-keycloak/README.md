...
helm upgrade --install p12-keycloak ./blueprints/patterns/p12-keycloak/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p12-keycloak-gdc ./blueprints/patterns/p12-keycloak/chart \
  --namespace my-gdc-project \
