...
"""
@file app.py
@brief Google Distributed Cloud Developer Environment (gdc-dev) Landing Page Service (Phase 1, Phase 2, & Phase 3 Agentic Platform).
...
<body>
    <div class="card">
        <h1>GDC Developer Environment (gdc-dev) <span class="badge">Phase 1/2/3</span></h1>
