...
resources:
  patterns:
    - name: "my-p1-resilient-3-tier-webapp"
      pattern: "p1-resilient-3-tier-webapp"
...
helm upgrade --install p1-resilient-3-tier-webapp ./blueprints/patterns/p1-resilient-3-tier-webapp/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p1-resilient-3-tier-webapp-gdc ./blueprints/patterns/p1-resilient-3-tier-webapp/chart \
  --namespace my-gdc-project \
