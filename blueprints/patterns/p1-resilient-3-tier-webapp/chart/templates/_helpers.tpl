...
*/}}
{{- define "p1-resilient-3-tier-webapp.name" -}}
...
*/}}
{{- define "p1-resilient-3-tier-webapp.fullname" -}}
...
*/}}
{{- define "p1-resilient-3-tier-webapp.namespace" -}}
...
*/}}
{{- define "p1-resilient-3-tier-webapp.projectId" -}}
...
*/}}
{{- define "p1-resilient-3-tier-webapp.registry" -}}
...
*/}}
{{- define "p1-resilient-3-tier-webapp.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p1-resilient-3-tier-webapp"
