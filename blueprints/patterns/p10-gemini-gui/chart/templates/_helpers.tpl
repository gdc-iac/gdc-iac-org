...
*/}}
{{- define "p10-gemini-gui.fullname" -}}
...
*/}}
{{- define "p10-gemini-gui.namespace" -}}
...
*/}}
{{- define "p10-gemini-gui.projectId" -}}
...
*/}}
{{- define "p10-gemini-gui.registry" -}}
...
*/}}
{{- define "p10-gemini-gui.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p10-gemini-gui"
