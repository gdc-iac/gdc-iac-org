...
resources:
  patterns:
    - name: "my-p10-gemini-gui"
      pattern: "p10-gemini-gui"
...
helm upgrade --install p10-gemini-gui ./blueprints/patterns/p10-gemini-gui/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p10-gemini-gui-gdc ./blueprints/patterns/p10-gemini-gui/chart \
  --namespace my-gdc-project \
