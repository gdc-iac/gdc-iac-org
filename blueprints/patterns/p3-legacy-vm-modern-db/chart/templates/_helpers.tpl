...
*/}}
{{- define "p3-legacy-vm-modern-db.name" -}}
...
*/}}
{{- define "p3-legacy-vm-modern-db.fullname" -}}
...
*/}}
{{- define "p3-legacy-vm-modern-db.namespace" -}}
...
*/}}
{{- define "p3-legacy-vm-modern-db.projectId" -}}
...
*/}}
{{- define "p3-legacy-vm-modern-db.registry" -}}
...
*/}}
{{- define "p3-legacy-vm-modern-db.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p3-legacy-vm-modern-db"
