...
resources:
  patterns:
    - name: "my-p3-legacy-vm-modern-db"
      pattern: "p3-legacy-vm-modern-db"
...
helm upgrade --install p3-legacy-vm-modern-db ./blueprints/patterns/p3-legacy-vm-modern-db/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p3-legacy-vm-modern-db-gdc ./blueprints/patterns/p3-legacy-vm-modern-db/chart \
  --namespace my-gdc-project \
