...
*/}}
{{- define "p7-agentic-data-analyst.name" -}}
...
*/}}
{{- define "p7-agentic-data-analyst.fullname" -}}
...
*/}}
{{- define "p7-agentic-data-analyst.namespace" -}}
...
*/}}
{{- define "p7-agentic-data-analyst.projectId" -}}
...
*/}}
{{- define "p7-agentic-data-analyst.registry" -}}
...
*/}}
{{- define "p7-agentic-data-analyst.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p7-agentic-data-analyst"
