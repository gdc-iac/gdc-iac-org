...
resources:
  patterns:
    - name: "my-p7-agentic-data-analyst"
      pattern: "p7-agentic-data-analyst"
...
helm upgrade --install p7-agentic-data-analyst ./blueprints/patterns/p7-agentic-data-analyst/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p7-agentic-data-analyst-gdc ./blueprints/patterns/p7-agentic-data-analyst/chart \
  --namespace my-gdc-project \
