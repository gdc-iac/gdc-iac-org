...
resources:
  patterns:
    - name: "my-p8-closed-loop-mlops"
      pattern: "p8-closed-loop-mlops"
...
helm upgrade --install p8-closed-loop-mlops ./blueprints/patterns/p8-closed-loop-mlops/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p8-closed-loop-mlops-gdc ./blueprints/patterns/p8-closed-loop-mlops/chart \
  --namespace my-gdc-project \
