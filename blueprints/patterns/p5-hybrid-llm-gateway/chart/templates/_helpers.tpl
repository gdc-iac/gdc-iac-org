...
*/}}
{{- define "p5-hybrid-llm-gateway.name" -}}
...
*/}}
{{- define "p5-hybrid-llm-gateway.fullname" -}}
...
*/}}
{{- define "p5-hybrid-llm-gateway.namespace" -}}
...
*/}}
{{- define "p5-hybrid-llm-gateway.projectId" -}}
...
*/}}
{{- define "p5-hybrid-llm-gateway.registry" -}}
...
*/}}
{{- define "p5-hybrid-llm-gateway.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p5-hybrid-llm-gateway"
