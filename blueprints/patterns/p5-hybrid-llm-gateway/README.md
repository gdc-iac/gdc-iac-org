...
resources:
  patterns:
    - name: "my-p5-hybrid-llm-gateway"
      pattern: "p5-hybrid-llm-gateway"
...
helm upgrade --install p5-hybrid-llm-gateway ./blueprints/patterns/p5-hybrid-llm-gateway/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p5-hybrid-llm-gateway-gdc ./blueprints/patterns/p5-hybrid-llm-gateway/chart \
  --namespace my-gdc-project \
