...
*/}}
{{- define "p6-resilient-rag-agent.name" -}}
...
*/}}
{{- define "p6-resilient-rag-agent.fullname" -}}
...
*/}}
{{- define "p6-resilient-rag-agent.namespace" -}}
...
*/}}
{{- define "p6-resilient-rag-agent.projectId" -}}
...
*/}}
{{- define "p6-resilient-rag-agent.registry" -}}
...
*/}}
{{- define "p6-resilient-rag-agent.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "p6-resilient-rag-agent"
