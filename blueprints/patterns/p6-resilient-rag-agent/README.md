...
resources:
  patterns:
    - name: "my-p6-resilient-rag-agent"
      pattern: "p6-resilient-rag-agent"
...
helm upgrade --install p6-resilient-rag-agent ./blueprints/patterns/p6-resilient-rag-agent/chart \
  --namespace my-gdc-project \
...
helm upgrade --install p6-resilient-rag-agent-gdc ./blueprints/patterns/p6-resilient-rag-agent/chart \
  --namespace my-gdc-project \
