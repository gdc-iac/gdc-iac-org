...
*/}}
{{- define "gemma-gemma-client.name" -}}
...
*/}}
{{- define "gemma-gemma-client.fullname" -}}
...
*/}}
{{- define "gemma-gemma-client.namespace" -}}
...
*/}}
{{- define "gemma-gemma-client.projectId" -}}
...
*/}}
{{- define "gemma-gemma-client.registry" -}}
...
*/}}
{{- define "gemma-gemma-client.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "gemma-gemma-client"
