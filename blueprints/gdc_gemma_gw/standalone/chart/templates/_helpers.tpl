...
*/}}
{{- define "gemma-standalone.fullname" -}}
...
*/}}
{{- define "gemma-standalone.namespace" -}}
...
*/}}
{{- define "gemma-standalone.projectId" -}}
...
*/}}
{{- define "gemma-standalone.registry" -}}
...
*/}}
{{- define "gemma-standalone.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name (.Chart.Version | replace "+" "_") }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: "gemma-standalone"
