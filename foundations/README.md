...
- **`5-patterns/`**: Orchestrates User Cluster application workloads for GDC Blueprint Patterns (`blueprints/patterns/*/chart`) while relying on Stage 2 (`2-resources`) for Zonal managed databases, VMs, and buckets.
...
│       └── 5-patterns/         <- GDC Blueprint Patterns workload stage
└── scripts/
